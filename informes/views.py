...
class InformeMantenimientosActivosView(View):
    def get(self, request):
        ...
        table.setStyle(TableStyle([
            ('BACKGROUND', (0, 0), (-1, 0), colors.grey), # Establece el color de fondo gris para la primera fila de la tabla.
            ('TEXTCOLOR', (0, 0), (-1, 0), colors.whitesmoke),#Esto afecta a la primera fila de la tabla.
            ...
            ('GRID', (0, 0), (-1, -1), 1, colors.black)#Agrega una cuadrícula con un ancho de línea y un color negro a todas las celdas de la tabla.
        ]))
